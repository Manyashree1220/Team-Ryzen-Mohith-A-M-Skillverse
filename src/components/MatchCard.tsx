...
import { User, Award, MapPin, Calendar, ChevronRight } from 'lucide-react'
...
export default function MatchCard({ candidateId, score, matchedSkills, evidence }: MatchCardProps) {
      ...
      <div className="bg-white dark:bg-gray-800/50 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 card-hover shadow-lg hover:shadow-2xl transition-all duration-300">
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            {matchedSkills.slice(0, 6).map((skill, index) => (
              <span
                key={index}
                className="px-3 py-1.5 bg-gradient-to-r from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30 text-blue-700 dark:text-blue-300 rounded-lg text-sm font-medium"
              >
                {skill}
              </span>
            ))}
        ...
        {evidence[0] && (
          <div className="mb-6">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 p-4 rounded-xl border-l-4 border-blue-500">
              <p className="text-gray-700 dark:text-gray-300 italic">"{evidence[0]}"</p>
            </div>
          </div>
        )}
        ...
        <button
          ...
          className="w-full flex items-center justify-center space-x-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 hover:shadow-lg"
        >
